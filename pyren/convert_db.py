...
if __name__ == "__main__":
    ...
    with zipfile.ZipFile(
        ...
        for vf in scnerariosfiles:
            ...
            data = f.read()
            zf.writestr(
                os.path.join("EcuRenault", "Scenarios", os.path.basename(vf)), str(data)
            )
        ...
        for vf in dfgfiles:
            ...
            data = f.read()
            zf.writestr(
                os.path.join("Vehicles", "DFG", os.path.basename(vf)), str(data)
            )
        ...
        for vf in fbsessionfiles:
            ...
            data = f.read()
            zf.writestr(
                os.path.join("EcuRenault", "Sessions", os.path.basename(vf)), str(data)
            )
