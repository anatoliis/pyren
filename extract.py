...
"""Check files"""
if (
    not os.path.exists("./i12comp.exe")
    or not os.path.exists("./data2.cab")
    or not os.path.exists("./data1.hdr")
):
...
for root, dirs, files in os.walk(
    "[Applicatif BORNEO_CLIP]NS_NSR_PL_1___[TARGETDIR]/CLIP/Data/GenAppli"
):
    targ = root.replace(
        "[Applicatif BORNEO_CLIP]NS_NSR_PL_1___[TARGETDIR]/CLIP/Data/GenAppli",
        clipImageDir,
