...
class optfile:
    ...
    def __init__(self, filename, progress=False, cache=True):
        ...
        if config.CLIP_ARC != "" and mod_db_manager.file_in_clip(filename[:-4] + ".p"):
    ...
    def get_dict(self, lf, progress):
        ...
        if self.fb != 0x55 and self.fb != 0xBD:
            self.obf = False
